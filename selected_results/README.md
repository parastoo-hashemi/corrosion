...
The current handoff reports are the [v3 five-page article](../final_reports/article.pdf)
and [v3 40-page thesis](../final_reports/thesis.pdf). The two papers kept in
