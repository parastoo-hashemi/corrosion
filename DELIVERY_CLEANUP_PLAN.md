...
Evidence: `archive/repository_maintenance/all_files_before.json`, `script_dependencies.json`,
...
|---|---:|---|---|
| `report_v2/evidence` | 173 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/evidence .` | `archive/repository_maintenance/references/000.txt` |
| `evidence` | 882 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- evidence .` | `archive/repository_maintenance/references/001.txt` |
| `report_v2/qa` | 30 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/qa .` | `archive/repository_maintenance/references/002.txt` |
| `qa` | 75 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- qa .` | `archive/repository_maintenance/references/003.txt` |
| `report_v2/critique` | 5 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/critique .` | `archive/repository_maintenance/references/004.txt` |
| `critique` | 24 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- critique .` | `archive/repository_maintenance/references/005.txt` |
| `activity_report/notes` | 5 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- activity_report/notes .` | `archive/repository_maintenance/references/006.txt` |
| `notes` | 88 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- notes .` | `archive/repository_maintenance/references/007.txt` |
| `AUGMENTATION_PLAN.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- AUGMENTATION_PLAN.md .` | `archive/repository_maintenance/references/008.txt` |
| `CLAUDE.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- CLAUDE.md .` | `archive/repository_maintenance/references/009.txt` |
| `DECISIONS.md` | 8 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- DECISIONS.md .` | `archive/repository_maintenance/references/010.txt` |
| `Documentation/augment_dataset_code_explanation.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augment_dataset_code_explanation.md .` | `archive/repository_maintenance/references/011.txt` |
| `augment_dataset_code_explanation.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augment_dataset_code_explanation.md .` | `archive/repository_maintenance/references/012.txt` |
| `Documentation/augmentation_email_analysis.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_email_analysis.md .` | `archive/repository_maintenance/references/013.txt` |
| `augmentation_email_analysis.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_email_analysis.md .` | `archive/repository_maintenance/references/014.txt` |
| `Documentation/augmentation_independent_plan.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_independent_plan.md .` | `archive/repository_maintenance/references/015.txt` |
| `augmentation_independent_plan.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_independent_plan.md .` | `archive/repository_maintenance/references/016.txt` |
| `Documentation/augmentation_journal_plan.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_journal_plan.md .` | `archive/repository_maintenance/references/017.txt` |
| `augmentation_journal_plan.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_journal_plan.md .` | `archive/repository_maintenance/references/018.txt` |
| `Documentation/augmentation_methodology_final.md` | 7 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_methodology_final.md .` | `archive/repository_maintenance/references/019.txt` |
| `augmentation_methodology_final.md` | 9 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_methodology_final.md .` | `archive/repository_maintenance/references/020.txt` |
| `Documentation/augmentation_methodology_report.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_methodology_report.md .` | `archive/repository_maintenance/references/021.txt` |
| `augmentation_methodology_report.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_methodology_report.md .` | `archive/repository_maintenance/references/022.txt` |
| `Documentation/augmentation_methodology_review.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_methodology_review.md .` | `archive/repository_maintenance/references/023.txt` |
| `augmentation_methodology_review.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_methodology_review.md .` | `archive/repository_maintenance/references/024.txt` |
| `Documentation/augmentation_objective_decision.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_objective_decision.md .` | `archive/repository_maintenance/references/025.txt` |
| `augmentation_objective_decision.md` | 9 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_objective_decision.md .` | `archive/repository_maintenance/references/026.txt` |
| `Documentation/augmentation_phase1_intent.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_phase1_intent.md .` | `archive/repository_maintenance/references/027.txt` |
| `augmentation_phase1_intent.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_phase1_intent.md .` | `archive/repository_maintenance/references/028.txt` |
| `Documentation/augmentation_phase2_professor_plan.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_phase2_professor_plan.md .` | `archive/repository_maintenance/references/029.txt` |
| `augmentation_phase2_professor_plan.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_phase2_professor_plan.md .` | `archive/repository_maintenance/references/030.txt` |
| `Documentation/augmentation_readiness_assessment.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/augmentation_readiness_assessment.md .` | `archive/repository_maintenance/references/031.txt` |
| `augmentation_readiness_assessment.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation_readiness_assessment.md .` | `archive/repository_maintenance/references/032.txt` |
| `Documentation/codex/make_splits_prompt.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/codex/make_splits_prompt.md .` | `archive/repository_maintenance/references/033.txt` |
| `make_splits_prompt.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- make_splits_prompt.md .` | `archive/repository_maintenance/references/034.txt` |
| `Documentation/final_augmentation_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/final_augmentation_strategy.md .` | `archive/repository_maintenance/references/035.txt` |
| `final_augmentation_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- final_augmentation_strategy.md .` | `archive/repository_maintenance/references/036.txt` |
| `Documentation/final_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/final_strategy.md .` | `archive/repository_maintenance/references/037.txt` |
| `final_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- final_strategy.md .` | `archive/repository_maintenance/references/038.txt` |
| `Documentation/project_review.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/project_review.md .` | `archive/repository_maintenance/references/039.txt` |
| `project_review.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- project_review.md .` | `archive/repository_maintenance/references/040.txt` |
| `Documentation/splitting_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/splitting_strategy.md .` | `archive/repository_maintenance/references/041.txt` |
| `splitting_strategy.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- splitting_strategy.md .` | `archive/repository_maintenance/references/042.txt` |
| `Documentation/verification_audit.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation/verification_audit.md .` | `archive/repository_maintenance/references/043.txt` |
| `verification_audit.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- verification_audit.md .` | `archive/repository_maintenance/references/044.txt` |
| `MORNING_SUMMARY.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- MORNING_SUMMARY.md .` | `archive/repository_maintenance/references/045.txt` |
| `REPORT_PLANNING.md` | 11 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- REPORT_PLANNING.md .` | `archive/repository_maintenance/references/046.txt` |
| `activity_report/CODEX_DELIVERY_CLEANUP_PROMPT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- activity_report/CODEX_DELIVERY_CLEANUP_PROMPT.md .` | `archive/repository_maintenance/references/047.txt` |
| `CODEX_DELIVERY_CLEANUP_PROMPT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- CODEX_DELIVERY_CLEANUP_PROMPT.md .` | `archive/repository_maintenance/references/048.txt` |
| `augmentation/README.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- augmentation/README.md .` | `archive/repository_maintenance/references/049.txt` |
| `README.md` | 36 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- README.md .` | `archive/repository_maintenance/references/050.txt` |
| `main/README.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main/README.md .` | `archive/repository_maintenance/references/051.txt` |
| `main_2/README.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_2/README.md .` | `archive/repository_maintenance/references/052.txt` |
| `main_3/README.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/README.md .` | `archive/repository_maintenance/references/053.txt` |
| `main_3/reports/meeting_report/executive_summary.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/executive_summary.md .` | `archive/repository_maintenance/references/054.txt` |
| `executive_summary.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- executive_summary.md .` | `archive/repository_maintenance/references/055.txt` |
| `main_3/reports/meeting_report/figures_explained.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/figures_explained.md .` | `archive/repository_maintenance/references/056.txt` |
| `figures_explained.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- figures_explained.md .` | `archive/repository_maintenance/references/057.txt` |
| `main_3/reports/meeting_report/limitations_and_next_steps.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/limitations_and_next_steps.md .` | `archive/repository_maintenance/references/058.txt` |
| `limitations_and_next_steps.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- limitations_and_next_steps.md .` | `archive/repository_maintenance/references/059.txt` |
| `main_3/reports/meeting_report/main2_vs_main3.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/main2_vs_main3.md .` | `archive/repository_maintenance/references/060.txt` |
| `main2_vs_main3.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main2_vs_main3.md .` | `archive/repository_maintenance/references/061.txt` |
| `main_3/reports/meeting_report/results_analysis.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/results_analysis.md .` | `archive/repository_maintenance/references/062.txt` |
| `results_analysis.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- results_analysis.md .` | `archive/repository_maintenance/references/063.txt` |
| `main_3/reports/meeting_report/talking_points.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/talking_points.md .` | `archive/repository_maintenance/references/064.txt` |
| `talking_points.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- talking_points.md .` | `archive/repository_maintenance/references/065.txt` |
| `main_3/reports/meeting_report/technical_report.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3/reports/meeting_report/technical_report.md .` | `archive/repository_maintenance/references/066.txt` |
| `technical_report.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- technical_report.md .` | `archive/repository_maintenance/references/067.txt` |
| `main_4/BENCHMARK_DIAGNOSTICS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/BENCHMARK_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/068.txt` |
| `BENCHMARK_DIAGNOSTICS.md` | 17 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- BENCHMARK_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/069.txt` |
| `main_4/CODEBASE_GUIDE.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/CODEBASE_GUIDE.md .` | `archive/repository_maintenance/references/070.txt` |
| `CODEBASE_GUIDE.md` | 8 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- CODEBASE_GUIDE.md .` | `archive/repository_maintenance/references/071.txt` |
| `main_4/COMPLETE_PROJECT_REPORT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/COMPLETE_PROJECT_REPORT.md .` | `archive/repository_maintenance/references/072.txt` |
| `COMPLETE_PROJECT_REPORT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- COMPLETE_PROJECT_REPORT.md .` | `archive/repository_maintenance/references/073.txt` |
| `main_4/CSV_SCHEMA_AUDIT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/CSV_SCHEMA_AUDIT.md .` | `archive/repository_maintenance/references/074.txt` |
| `CSV_SCHEMA_AUDIT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- CSV_SCHEMA_AUDIT.md .` | `archive/repository_maintenance/references/075.txt` |
| `main_4/FEATURE_DIAGNOSTICS.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/FEATURE_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/076.txt` |
| `FEATURE_DIAGNOSTICS.md` | 20 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FEATURE_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/077.txt` |
| `main_4/FIGURE_EXPLANATION_GUIDE.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/FIGURE_EXPLANATION_GUIDE.md .` | `archive/repository_maintenance/references/078.txt` |
| `FIGURE_EXPLANATION_GUIDE.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FIGURE_EXPLANATION_GUIDE.md .` | `archive/repository_maintenance/references/079.txt` |
| `main_4/FIGURE_REVIEW.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/FIGURE_REVIEW.md .` | `archive/repository_maintenance/references/080.txt` |
| `FIGURE_REVIEW.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FIGURE_REVIEW.md .` | `archive/repository_maintenance/references/081.txt` |
| `main_4/FIXES_APPLIED.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/FIXES_APPLIED.md .` | `archive/repository_maintenance/references/082.txt` |
| `FIXES_APPLIED.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FIXES_APPLIED.md .` | `archive/repository_maintenance/references/083.txt` |
| `main_4/IMPLEMENTATION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/IMPLEMENTATION_PLAN.md .` | `archive/repository_maintenance/references/084.txt` |
| `IMPLEMENTATION_PLAN.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- IMPLEMENTATION_PLAN.md .` | `archive/repository_maintenance/references/085.txt` |
| `main_4/MODEL_IMPROVEMENTS_APPLIED.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/MODEL_IMPROVEMENTS_APPLIED.md .` | `archive/repository_maintenance/references/086.txt` |
| `MODEL_IMPROVEMENTS_APPLIED.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- MODEL_IMPROVEMENTS_APPLIED.md .` | `archive/repository_maintenance/references/087.txt` |
| `main_4/MODEL_IMPROVEMENT_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/MODEL_IMPROVEMENT_PLAN.md .` | `archive/repository_maintenance/references/088.txt` |
| `MODEL_IMPROVEMENT_PLAN.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- MODEL_IMPROVEMENT_PLAN.md .` | `archive/repository_maintenance/references/089.txt` |
| `main_4/MODEL_IMPROVEMENT_RESULTS.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/MODEL_IMPROVEMENT_RESULTS.md .` | `archive/repository_maintenance/references/090.txt` |
| `MODEL_IMPROVEMENT_RESULTS.md` | 13 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- MODEL_IMPROVEMENT_RESULTS.md .` | `archive/repository_maintenance/references/091.txt` |
| `main_4/NEXT_STEPS_PLAN.md` | 11 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/NEXT_STEPS_PLAN.md .` | `archive/repository_maintenance/references/092.txt` |
| `NEXT_STEPS_PLAN.md` | 18 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- NEXT_STEPS_PLAN.md .` | `archive/repository_maintenance/references/093.txt` |
| `main_4/OUTPUT_REVIEW.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/OUTPUT_REVIEW.md .` | `archive/repository_maintenance/references/094.txt` |
| `OUTPUT_REVIEW.md` | 23 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- OUTPUT_REVIEW.md .` | `archive/repository_maintenance/references/095.txt` |
| `main_4/OUTPUT_VISUALIZATION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/OUTPUT_VISUALIZATION_PLAN.md .` | `archive/repository_maintenance/references/096.txt` |
| `OUTPUT_VISUALIZATION_PLAN.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- OUTPUT_VISUALIZATION_PLAN.md .` | `archive/repository_maintenance/references/097.txt` |
| `main_4/PROJECT_AUDIT.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/PROJECT_AUDIT.md .` | `archive/repository_maintenance/references/098.txt` |
| `PROJECT_AUDIT.md` | 7 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- PROJECT_AUDIT.md .` | `archive/repository_maintenance/references/099.txt` |
| `main_4/PROJECT_CONSTRAINTS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/PROJECT_CONSTRAINTS.md .` | `archive/repository_maintenance/references/100.txt` |
| `PROJECT_CONSTRAINTS.md` | 8 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- PROJECT_CONSTRAINTS.md .` | `archive/repository_maintenance/references/101.txt` |
| `main_4/PROJECT_EXPLANATION_FOR_PRESENTATION.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/PROJECT_EXPLANATION_FOR_PRESENTATION.md .` | `archive/repository_maintenance/references/102.txt` |
| `PROJECT_EXPLANATION_FOR_PRESENTATION.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- PROJECT_EXPLANATION_FOR_PRESENTATION.md .` | `archive/repository_maintenance/references/103.txt` |
| `main_4/README.md` | 9 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/README.md .` | `archive/repository_maintenance/references/104.txt` |
| `main_4/REPORT_EDIT_SUMMARY.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/REPORT_EDIT_SUMMARY.md .` | `archive/repository_maintenance/references/105.txt` |
| `REPORT_EDIT_SUMMARY.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- REPORT_EDIT_SUMMARY.md .` | `archive/repository_maintenance/references/106.txt` |
| `main_4/SCIENTIFIC_REPORT.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/SCIENTIFIC_REPORT.md .` | `archive/repository_maintenance/references/107.txt` |
| `SCIENTIFIC_REPORT.md` | 32 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- SCIENTIFIC_REPORT.md .` | `archive/repository_maintenance/references/108.txt` |
| `main_4/SCIENTIFIC_SOLUTION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4/SCIENTIFIC_SOLUTION_PLAN.md .` | `archive/repository_maintenance/references/109.txt` |
| `SCIENTIFIC_SOLUTION_PLAN.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- SCIENTIFIC_SOLUTION_PLAN.md .` | `archive/repository_maintenance/references/110.txt` |
| `main_4_old/BENCHMARK_DIAGNOSTICS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/BENCHMARK_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/111.txt` |
| `main_4_old/CODEBASE_GUIDE.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/CODEBASE_GUIDE.md .` | `archive/repository_maintenance/references/112.txt` |
| `main_4_old/COMPLETE_PROJECT_REPORT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/COMPLETE_PROJECT_REPORT.md .` | `archive/repository_maintenance/references/113.txt` |
| `main_4_old/CSV_SCHEMA_AUDIT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/CSV_SCHEMA_AUDIT.md .` | `archive/repository_maintenance/references/114.txt` |
| `main_4_old/FEATURE_DIAGNOSTICS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/FEATURE_DIAGNOSTICS.md .` | `archive/repository_maintenance/references/115.txt` |
| `main_4_old/FIGURE_EXPLANATION_GUIDE.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/FIGURE_EXPLANATION_GUIDE.md .` | `archive/repository_maintenance/references/116.txt` |
| `main_4_old/FIGURE_REVIEW.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/FIGURE_REVIEW.md .` | `archive/repository_maintenance/references/117.txt` |
| `main_4_old/FIXES_APPLIED.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/FIXES_APPLIED.md .` | `archive/repository_maintenance/references/118.txt` |
| `main_4_old/IMPLEMENTATION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/IMPLEMENTATION_PLAN.md .` | `archive/repository_maintenance/references/119.txt` |
| `main_4_old/MODEL_IMPROVEMENTS_APPLIED.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/MODEL_IMPROVEMENTS_APPLIED.md .` | `archive/repository_maintenance/references/120.txt` |
| `main_4_old/MODEL_IMPROVEMENT_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/MODEL_IMPROVEMENT_PLAN.md .` | `archive/repository_maintenance/references/121.txt` |
| `main_4_old/MODEL_IMPROVEMENT_RESULTS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/MODEL_IMPROVEMENT_RESULTS.md .` | `archive/repository_maintenance/references/122.txt` |
| `main_4_old/NEXT_STEPS_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/NEXT_STEPS_PLAN.md .` | `archive/repository_maintenance/references/123.txt` |
| `main_4_old/OUTPUT_REVIEW.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/OUTPUT_REVIEW.md .` | `archive/repository_maintenance/references/124.txt` |
| `main_4_old/OUTPUT_VISUALIZATION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/OUTPUT_VISUALIZATION_PLAN.md .` | `archive/repository_maintenance/references/125.txt` |
| `main_4_old/PROJECT_AUDIT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/PROJECT_AUDIT.md .` | `archive/repository_maintenance/references/126.txt` |
| `main_4_old/PROJECT_CONSTRAINTS.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/PROJECT_CONSTRAINTS.md .` | `archive/repository_maintenance/references/127.txt` |
| `main_4_old/PROJECT_EXPLANATION_FOR_PRESENTATION.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/PROJECT_EXPLANATION_FOR_PRESENTATION.md .` | `archive/repository_maintenance/references/128.txt` |
| `main_4_old/README.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/README.md .` | `archive/repository_maintenance/references/129.txt` |
| `main_4_old/REPORT_EDIT_SUMMARY.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/REPORT_EDIT_SUMMARY.md .` | `archive/repository_maintenance/references/130.txt` |
| `main_4_old/SCIENTIFIC_REPORT.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/SCIENTIFIC_REPORT.md .` | `archive/repository_maintenance/references/131.txt` |
| `main_4_old/SCIENTIFIC_SOLUTION_PLAN.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old/SCIENTIFIC_SOLUTION_PLAN.md .` | `archive/repository_maintenance/references/132.txt` |
| `report_v2/DECISIONS.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/DECISIONS.md .` | `archive/repository_maintenance/references/133.txt` |
| `report_v2/FINAL_VERIFICATION.md` | 0 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/FINAL_VERIFICATION.md .` | `archive/repository_maintenance/references/134.txt` |
| `FINAL_VERIFICATION.md` | 6 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FINAL_VERIFICATION.md .` | `archive/repository_maintenance/references/135.txt` |
| `report_v2/MORNING_SUMMARY.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/MORNING_SUMMARY.md .` | `archive/repository_maintenance/references/136.txt` |
| `report_v2/README.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/README.md .` | `archive/repository_maintenance/references/137.txt` |
| `report_v2/RESEARCH_NOTES.md` | 2 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/RESEARCH_NOTES.md .` | `archive/repository_maintenance/references/138.txt` |
| `RESEARCH_NOTES.md` | 4 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- RESEARCH_NOTES.md .` | `archive/repository_maintenance/references/139.txt` |
| `report_v2/VERIFICATION_LOG.md` | 7 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/VERIFICATION_LOG.md .` | `archive/repository_maintenance/references/140.txt` |
| `VERIFICATION_LOG.md` | 10 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- VERIFICATION_LOG.md .` | `archive/repository_maintenance/references/141.txt` |
| `report_v2/thesis/v3/FIGURE_AUDIT.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/thesis/v3/FIGURE_AUDIT.md .` | `archive/repository_maintenance/references/142.txt` |
| `FIGURE_AUDIT.md` | 7 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- FIGURE_AUDIT.md .` | `archive/repository_maintenance/references/143.txt` |
| `report_v2/thesis/v3/V3_CHANGE_SUMMARY.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- report_v2/thesis/v3/V3_CHANGE_SUMMARY.md .` | `archive/repository_maintenance/references/144.txt` |
| `V3_CHANGE_SUMMARY.md` | 1 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- V3_CHANGE_SUMMARY.md .` | `archive/repository_maintenance/references/145.txt` |
| `activity_report/CODEX_AUTONOMOUS_PROMPT.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- activity_report/CODEX_AUTONOMOUS_PROMPT.md .` | `archive/repository_maintenance/references/146.txt` |
| `CODEX_AUTONOMOUS_PROMPT.md` | 3 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- CODEX_AUTONOMOUS_PROMPT.md .` | `archive/repository_maintenance/references/147.txt` |
| `main` | 5571 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main .` | `archive/repository_maintenance/references/148.txt` |
| `main_2` | 423 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_2 .` | `archive/repository_maintenance/references/149.txt` |
| `main_3` | 764 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_3 .` | `archive/repository_maintenance/references/150.txt` |
| `main_4` | 1405 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4 .` | `archive/repository_maintenance/references/151.txt` |
| `main_first` | 156 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_first .` | `archive/repository_maintenance/references/152.txt` |
| `main_4_old` | 10 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- main_4_old .` | `archive/repository_maintenance/references/153.txt` |
| `out` | 75650 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- out .` | `archive/repository_maintenance/references/154.txt` |
| `Documentation` | 140 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- Documentation .` | `archive/repository_maintenance/references/155.txt` |
| `emiling` | 71 | `rg --hidden --no-ignore -n -F -g '!.git/**' -- emiling .` | `archive/repository_maintenance/references/156.txt` |
...
archive/repository_maintenance/                   # machine-readable cleanup evidence and checks
```
