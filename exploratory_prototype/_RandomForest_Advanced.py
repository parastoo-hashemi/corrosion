...
def extract_material_features(sample_name):
    ...
    # Feature main_first: Has Fiber? (VF indicates Vetro Fibra / Steel Fiber)
    ...
    # We take the main_first letter for Campaign 2, or main_first 2 chars for Campaign main_first
