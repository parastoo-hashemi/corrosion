...
legacy experiment roots and the old `emiling/` collection prefixes are translated.
...
The 25 existing links to archived documents remain part of the delivery. Preserve
those links when copying. `main_first` also occurs as pre-existing corrupted
