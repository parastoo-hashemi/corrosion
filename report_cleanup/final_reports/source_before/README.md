...
|---|---|
| Understand the scientific work | [Five-page article](report_v2/article/v3/article.pdf), then the [40-page thesis](report_v2/thesis/v3/thesis.pdf) |
...
| [report_v2/](report_v2/) | Current v3 article/thesis, scientific figures, tables and retained analysis scripts |
