...
P=ROOT/'main_4/outputs/ultimate_load_refocus/pooled_all_weeks/grouped_cv/experiments/metadata_only/Ridge'
...
(OUT/'evidence/v3/new_figure_checks.json').write_text(json.dumps(checks,indent=2)+'\n')
