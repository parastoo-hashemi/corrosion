...
from corrosion.main_2.models import RegressionMLP
...
def load_phase2_artifacts(artifacts_dir: Path) -> Phase2Artifacts:
    ...
    model_state_path = Path(run_info["phase2_model"]["artifacts"]["model_state"])
    preprocessor_path = Path(run_info["phase2_model"]["artifacts"]["tabular_preprocessor"])
    scaler_path = Path(run_info["phase2_model"]["artifacts"]["target_scaler"])
