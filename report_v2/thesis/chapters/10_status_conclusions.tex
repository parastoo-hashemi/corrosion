...
\caption{Prepared four-class total-rust manifests. Counts come from the actual retained manifests, not the larger global augmentation inventory. All 48 specimens are assigned to disjoint splits; validation and test contain originals only. These are data-preparation counts and imply no classification performance.}\label{tab:classsplits}
\input{\shared/tables/classification_splits.tex}
\end{table}
