...
master='main_4/outputs/data/master_table.csv'
...
finish(fig,'evaluation_regimes',['main_4/outputs/splits/master_group_shuffle.csv','main_4/outputs/splits/master_leave_one_treatment_out.csv','main_4/outputs/splits/master_leave_one_campaign_out.csv'],'Conceptual grouping schematic checked against saved specimen-disjoint manifests.')
...
finish(fig,'robustness_synthesis',['main_3/outputs/corrosion_regression_metrics.csv','main_3/outputs/damage_regression_metrics.csv','main_4/outputs/diagnostics/tables/benchmark_best_model_robustness.csv'],'Within-generation normalized MAE; fixed grouped-holdout winner tracked by target. Not a cross-generation raw-metric ranking.')

f=raw('main_4/outputs/features/image_features.csv');m=d.merge(f[['sample_name','img_rust_area_ratio_pct']],on='sample_name')
...
finish(fig,'threshold_status',['main_4/outputs/models/proxy_rul/proxy_rul_estimates.csv','main_4/configs/thresholds.yaml'],'Statuses of model-derived wire-loss trajectories, not observed failure events.')
